...
function Stash(urlString, user, pass) {
  ...
  this.client = new stashApi.StashApi(urlObject.protocol.replace(/\:$/, ''), urlObject.hostname, urlObject.port, user, pass);
}
...
Stash.prototype.generate = function (cb) {
  ...
  var config = {};
  this.client.getProjects().spread(function (response, body) {
