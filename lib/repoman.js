...
var os        = require('os');
var p         = require('path');
var Stash     = require('./generator/stash');
...
Repoman.prototype.config = function (opts, cb) {
  ...
  if (opts.bitbucket) {
    ...
    console.log('Setting configuration file: %s, with Stash repositories', CONFIG_FILE);
    var stash = new Stash(opts.stash.url, opts.stash.authUser, opts.stash.authPass);
    stash.generate(_saveConfig);
